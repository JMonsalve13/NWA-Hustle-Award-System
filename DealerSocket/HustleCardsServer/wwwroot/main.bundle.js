...
var AppComponent = (function () {
    ...
    AppComponent.prototype.ngOnInit = function () {
        ...
        this._httpService.get('/api/person').subscribe(function (values) {
            _this.apiValues = values.json();
            _this.message = _this.apiValues[3];
            console.log(_this.message);
            _this.myContainer.innerHTML = _this.message;
        });
    };
    return AppComponent;
}());
